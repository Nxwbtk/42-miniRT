...
/*   Updated: 2023/11/24 23:48:30 by bsirikam         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_viewport(t_viewport *viewport, t_camera camera)
{
	...
	viewport_upper_left = vec_sub(vec_sub(camera.dir, new_vec(0, 0, 1.0)), \
	vec_div(viewport_u, 2));
	...
	vec_multi_scalar(vec_add(viewport->pixel_delta_x, viewport->pixel_delta_y), \
	0.5));
}
